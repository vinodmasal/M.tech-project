# -*- coding: utf-8 -*-
"""SimpleRNN Model Hyperparameter Tunning.ipynb
...
def create_model(learn_rate=0.01):
	# create model
  # design network
  # First SimpleRNN hidden layer
  model = Sequential()
  model.add(SimpleRNN(units=40, input_shape=(train_X.shape[1], train_X.shape[2])))
...
results.to_csv("SimpleRNN_Learning Rate and Momentum.csv")
# files.download('SimpleRNN_Learning Rate and Momentum.csv')
...
def create_model(neurons=1):
  ...
  # design network
  model = Sequential()
  model.add(SimpleRNN(neurons, input_shape=(train_X.shape[1], train_X.shape[2])))
  model.add(Dropout(0.2))
  model.add(Dense(1))
...
results['params'] =  grid_result.cv_results_['params']
results.to_csv("SimpleRNN_Network Weight Initialization.csv")
files.download('SimpleRNN_Network Weight Initialization.csv')
...
results['params'] =  grid_result.cv_results_['params']
results.to_csv("RNN_Batch size and epoch.csv")
files.download('RNN_Batch size and epoch.csv')
...
def create_model(init_mode='uniform'):
  ...
  # design network
  model = Sequential()
  model.add(SimpleRNN(units=40, kernel_initializer=init_mode, input_shape=(train_X.shape[1], train_X.shape[2])))
...
results['params'] =  grid_result.cv_results_['params']
results.to_csv("SimpleRNN_Neuron Activation Function.csv")
files.download('SimpleRNN_Neuron Activation Function.csv')
...
results['params'] =  grid_result.cv_results_['params']
results.to_csv("SimpleRNN_Dropout Regularization.csv")
files.download('SimpleRNN_Dropout Regularization.csv')
...
results['params'] =  grid_result.cv_results_['params']
results.to_csv("SimpleRNN_Number of Neurons in the Hidden Layer.csv")
files.download('SimpleRNN_Number of Neurons in the Hidden Layer.csv')